  ...
  const testimonials = [
    {
      ...
      content:
        'PrismaCV Builder helped me land my dream job at Google! The ATS optimization feature ensured my resume made it through their system.',
    ...
    },
    {
      ...
      content:
        "I've tried many resume builders, but PrismaCV is the first that truly understands what recruiters are looking for.",
      ...
      <nav className="bg-white shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center">
          <span className="text-2xl font-bold text-primary">
            Prisma<span className="text-gray-800">CV</span>
          </span>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
                ...
                hired faster. PrismaCV offers AI-powered optimization, skill gap
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-primary mb-4">PrismaCV</h3>
            ...
            <div>
              ...
              <p className="text-gray-400 mt-2">© 2025 PrismaCV</p>
            </div>
          </div>

          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
            <p>© 2025 PrismaCV. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
