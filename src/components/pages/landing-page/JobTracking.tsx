...
const trackingCards = [
  {
    ...
    title: "aved",
    fullTitle: "Saved",
    description: "Save job opportunities you are interested in and review them later.",
    bgColor: "bg-[#B8DFE6]",
  ...
  },
  {
    ...
    title: "ejected",
    fullTitle: "Rejected",
    description: "See which applications were rejected and learn where to improve.",
    bgColor: "bg-[#FFCDD2]",
...
export const JobTracking = () => {
  return (
    <section 
      ...
      style={{
        background: 'linear-gradient(179.84deg, #FFFFFF 0%, rgba(57, 177, 185, 0.15) 100%)'
      }}
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">
            Stay organized and in control of your job search. Our tracker helps you manage every application, from saved opportunities to final offers, all in one place.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {trackingCards.map((card) => (
            ...
            >
              ...
              <div className={`${card.bgColor} rounded-t-2xl p-6 pb-20 flex flex-col gap-3`}>
