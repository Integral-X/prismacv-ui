...
const pricingTiers: PricingTier[] = [
  ...
  {
    name: "Professional",
    description: "Ideal for individuals who who need advanced features and tools.",
    monthlyPrice: 25,
    yearlyPrice: 19,
    features: [
...
export const Pricing = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-linear-to-b from-white to-gray-50" id="pricing">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Simple tools. Fair prices. CrackCV helps you create polished resumes, standout applications, cover letters, and personal websites with ease.
          </p>
          ...
          <div className="flex items-center justify-center relative">
            ...
            <div className="absolute left-1/2 flex items-center ml-44 mt-8">
              <img
                ...
                aria-hidden="true"
              />
              <span className="text-primary font-medium relative z-10 mt-4">Save 25%</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {pricingTiers.map((tier) => (
            ...
            >
              {/* Card Header */}
              <div className="mb-6">
                <h3 className={`text-2xl font-semibold mb-2 ${tier.featured ? "text-white" : "text-gray-900"}`}>
                  {tier.name}
                </h3>
                <p className={`text-sm ${tier.featured ? "text-white/80" : "text-muted-foreground"}`}>
                  {tier.description}
                </p>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  ...
                  <span className={`text-lg ${tier.featured ? "text-white/70" : "text-muted-foreground"}`}>
                    / Month
                  </span>
                </div>
              </div>
